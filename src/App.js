     ...
     <Router>
      ...
      />
        <Switch>
          ...
          <Route exact path="/business"><News setProgress={setProgress} key="buiness" pageSize={pageSize} country="in" category="Business"/></Route>
...
//           <Route exact path="/business"><News setProgress={this.setProgress} key="buiness" pageSize={this.pageSize} country="in" category="Business"/></Route>
